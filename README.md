...
├── run_smc_benchmark.py                    # script to run bench_smc.jl for every model
└── run_vi_benchmark.py                    # script to run bench_vi.jl for every model
```
...
docker load < pplstaticfactor.tar.gz
docker run -it --name pplstaticfactor --rm pplstaticfactor

docker commit pplstaticfactor pplstaticfactor
docker save pplstaticfactor | gzip > pplstaticfactor.tar.gz
