...
function gmm(ctx::AbstractSampleRecordStateContext, ys::Vector{Float64}, _s_::State)
    ...
    _s_.w::Vector{Float64} = sample_record_state(ctx, _s_, 57, "w", Dirichlet(fill(_s_.δ, _s_.num_clusters)))
    _s_.k::Int = 1
    _s_.means::Vector{Float64} = Float64[]
    _s_.vars::Vector{Float64} = Float64[]
    while (_s_.k <= _s_.num_clusters)
        _s_.mu::Float64 = sample_record_state(ctx, _s_, 101, ("mu_" * string(_s_.k)), Normal(_s_.ξ, (1 / sqrt(_s_.κ))))
        _s_.var::Float64 = sample_record_state(ctx, _s_, 124, ("var_" * string(_s_.k)), InverseGamma(_s_.α, _s_.β))
    ...
    while (_s_.i <= length(ys))
        _s_.z::Int = sample_record_state(ctx, _s_, 173, ("z_" * string(_s_.i)), Categorical(_s_.w))
        _s_.z = min(_s_.z, length(_s_.means))
        _ = sample_record_state(ctx, _s_, 198, ("y_" * string(_s_.i)), Normal(get_n(_s_.means, _s_.z), get_n(_s_.vars, _s_.z)), observed = get_n(ys, _s_.i))
        _s_.i = (_s_.i + 1)
    end
end
...
function gmm_mu__101(ctx::AbstractFactorRevisitContext, ys::Vector{Float64}, _s_::State)
    ...
    _s_.var = read(ctx, _s_, 124, ("var_" * string(_s_.k)))
    _s_.means = vcat(_s_.means, _s_.mu)
    _s_.vars = vcat(_s_.vars, _s_.var)
    _s_.k = (_s_.k + 1)
    while (_s_.k <= _s_.num_clusters)
        _s_.mu = read(ctx, _s_, 101, ("mu_" * string(_s_.k)))
        _s_.var = read(ctx, _s_, 124, ("var_" * string(_s_.k)))
        _s_.means = vcat(_s_.means, _s_.mu)
        _s_.vars = vcat(_s_.vars, _s_.var)
        _s_.k = (_s_.k + 1)
    ...
    _s_.i = 1
    while (_s_.i <= length(ys))
        _s_.z = read(ctx, _s_, 173, ("z_" * string(_s_.i)))
        _s_.z = min(_s_.z, length(_s_.means))
...
function gmm_w_57(ctx::AbstractFactorRevisitContext, ys::Vector{Float64}, _s_::State)
    ...
    _s_.i = 1
    while (_s_.i <= length(ys))
        _s_.z = score(ctx, _s_, 173, ("z_" * string(_s_.i)), Categorical(_s_.w))
        _s_.z = min(_s_.z, length(_s_.means))
        read(ctx, _s_, 198, ("y_" * string(_s_.i)), observed = get_n(ys, _s_.i))
        _s_.i = (_s_.i + 1)
    end
end
...
function gmm_factor(ctx::AbstractFactorRevisitContext, ys::Vector{Float64}, _s_::State, _addr_::String)
    ...
    if _s_.node_id == 124
        return gmm_var__124(ctx, ys, _s_)
    end
    if _s_.node_id == 57
        return gmm_w_57(ctx, ys, _s_)
    end
    if _s_.node_id == 173
        return gmm_z__173(ctx, ys, _s_)
    end
...
function gmm___start__(ctx::AbstractFactorResumeContext, ys::Vector{Float64}, _s_::State)
    ...
    _s_.β = 10.0
    _s_.num_clusters = 4
    _s_.w = score(ctx, _s_, 57, "w", Dirichlet(fill(_s_.δ, _s_.num_clusters)))
    _s_.k = 1
    _s_.means = Float64[]
    _s_.vars = Float64[]
    while (_s_.k <= _s_.num_clusters)
        _s_.mu = score(ctx, _s_, 101, ("mu_" * string(_s_.k)), Normal(_s_.ξ, (1 / sqrt(_s_.κ))))
        _s_.var = score(ctx, _s_, 124, ("var_" * string(_s_.k)), InverseGamma(_s_.α, _s_.β))
        _s_.means = vcat(_s_.means, _s_.mu)
        _s_.vars = vcat(_s_.vars, _s_.var)
        _s_.k = (_s_.k + 1)
    end
...
function gmm_y__198(ctx::AbstractFactorResumeContext, ys::Vector{Float64}, _s_::State)
    resume(ctx, _s_, 198, ("y_" * string(_s_.i)), Normal(get_n(_s_.means, _s_.z), get_n(_s_.vars, _s_.z)), observed = get_n(ys, _s_.i))
    _s_.i = (_s_.i + 1)
    while (_s_.i <= length(ys))
        _s_.z = score(ctx, _s_, 173, ("z_" * string(_s_.i)), Categorical(_s_.w))
        _s_.z = min(_s_.z, length(_s_.means))
