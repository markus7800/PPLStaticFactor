...
function hurricane_D0_161(ctx::AbstractFactorVisitContext, _s_::State)
    _s_.damage_0 = visit(ctx, _s_, 161, "D0", Bernoulli((_s_.prep_0 == 1) ? 0.2 : 0.8))
end

function hurricane_D0_70(ctx::AbstractFactorVisitContext, _s_::State)
    _s_.damage_0 = visit(ctx, _s_, 70, "D0", Bernoulli((_s_.prep_0 == 1) ? 0.2 : 0.8))
    _s_.prep_1 = score(ctx, _s_, 86, "P1", Bernoulli((_s_.damage_0 == 1) ? 0.75 : 0.5))
end

function hurricane_D1_102(ctx::AbstractFactorVisitContext, _s_::State)
    _s_.damage_1 = visit(ctx, _s_, 102, "D1", Bernoulli((_s_.prep_1 == 1) ? 0.2 : 0.8))
end

function hurricane_D1_129(ctx::AbstractFactorVisitContext, _s_::State)
    _s_.damage_1 = visit(ctx, _s_, 129, "D1", Bernoulli((_s_.prep_1 == 1) ? 0.2 : 0.8))
    _s_.prep_0 = score(ctx, _s_, 145, "P0", Bernoulli((_s_.damage_1 == 1) ? 0.75 : 0.5))
end

function hurricane_F_22(ctx::AbstractFactorVisitContext, _s_::State)
    _s_.first_city_ixs = visit(ctx, _s_, 22, "F", Bernoulli(0.5))
    _s_.prep_0 = 0
    _s_.damage_0 = 0
    _s_.prep_1 = 0
    _s_.damage_1 = 0
...
function hurricane_P0_145(ctx::AbstractFactorVisitContext, _s_::State)
    _s_.prep_0 = visit(ctx, _s_, 145, "P0", Bernoulli((_s_.damage_1 == 1) ? 0.75 : 0.5))
    _s_.damage_0 = score(ctx, _s_, 161, "D0", Bernoulli((_s_.prep_0 == 1) ? 0.2 : 0.8))
end

function hurricane_P0_60(ctx::AbstractFactorVisitContext, _s_::State)
    _s_.prep_0 = visit(ctx, _s_, 60, "P0", Bernoulli(0.5))
    _s_.damage_0 = score(ctx, _s_, 70, "D0", Bernoulli((_s_.prep_0 == 1) ? 0.2 : 0.8))
end

function hurricane_P1_119(ctx::AbstractFactorVisitContext, _s_::State)
    _s_.prep_1 = visit(ctx, _s_, 119, "P1", Bernoulli(0.5))
    _s_.damage_1 = score(ctx, _s_, 129, "D1", Bernoulli((_s_.prep_1 == 1) ? 0.2 : 0.8))
end

function hurricane_P1_86(ctx::AbstractFactorVisitContext, _s_::State)
    _s_.prep_1 = visit(ctx, _s_, 86, "P1", Bernoulli((_s_.damage_0 == 1) ? 0.75 : 0.5))
    _s_.damage_1 = score(ctx, _s_, 102, "D1", Bernoulli((_s_.prep_1 == 1) ? 0.2 : 0.8))
end

function hurricane_factor(ctx::AbstractFactorVisitContext, _s_::State, _addr_::String)
    if _s_.node_id == 161
