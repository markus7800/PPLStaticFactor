...
function lda_phi(ctx::AbstractManualVisitContext, M::Int, N::Int, V::Int, w::Vector{Int}, doc::Vector{Int}, addr::String)
...
function lda_theta(ctx::AbstractManualVisitContext, M::Int, N::Int, V::Int, w::Vector{Int}, doc::Vector{Int}, addr::String)
    K::Int = 2 # num topics
...
function lda_z(ctx::AbstractManualVisitContext, M::Int, N::Int, V::Int, w::Vector{Int}, doc::Vector{Int}, addr::String)
