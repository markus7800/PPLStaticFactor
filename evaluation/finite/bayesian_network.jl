...
function bayesian_network_ANAPHYLAXIS(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    ANAPHYLAXIS_old::Int = manual_read(ctx, "ANAPHYLAXIS")
    ANAPHYLAXIS_new::Int = manual_resample(ctx, "ANAPHYLAXIS", Categorical(get_cpt(CPTs, "ANAPHYLAXIS"), check_args = false))
...
function bayesian_network_ARTCO2(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    ...
    ARTCO2_new::Int = manual_resample(ctx, "ARTCO2", Categorical(get_cpt(CPTs, "ARTCO2", VENTALV), check_args = false))
...
function bayesian_network_BP(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    TPR::Int = manual_read(ctx, "TPR")
    CO::Int = manual_read(ctx, "CO")

    BP_old::Int = manual_read(ctx, "BP")
    BP_new::Int = manual_resample(ctx, "BP", Categorical(get_cpt(CPTs, "BP", CO, TPR), check_args = false))
end

function bayesian_network_CATECHOL(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    ...
    CATECHOL_new::Int = manual_resample(ctx, "CATECHOL", Categorical(get_cpt(CPTs, "CATECHOL", ARTCO2, INSUFFANESTH, SAO2, TPR), check_args = false))
...
function bayesian_network_CO(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    TPR::Int = manual_read(ctx, "TPR")
    HR::Int = manual_read(ctx, "HR")
    STROKEVOLUME::Int = manual_read(ctx, "STROKEVOLUME")

    CO_old::Int = manual_read(ctx, "CO")
    CO_new::Int = manual_resample(ctx, "CO", Categorical(get_cpt(CPTs, "CO", HR, STROKEVOLUME), check_args = false))
...
function bayesian_network_CVP(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    LVEDVOLUME::Int = manual_read(ctx, "LVEDVOLUME")

    CVP_old::Int = manual_read(ctx, "CVP")
    CVP_new::Int = manual_resample(ctx, "CVP", Categorical(get_cpt(CPTs, "CVP", LVEDVOLUME), check_args = false))
end

function bayesian_network_DISCONNECT(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    VENTMACH::Int = manual_read(ctx, "VENTMACH")

    DISCONNECT_old::Int = manual_read(ctx, "DISCONNECT")
    DISCONNECT_new::Int = manual_resample(ctx, "DISCONNECT", Categorical(get_cpt(CPTs, "DISCONNECT"), check_args = false))
...
function bayesian_network_ERRCAUTER(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    HR::Int = manual_read(ctx, "HR")

    ERRCAUTER_old::Int = manual_read(ctx, "ERRCAUTER")
    ERRCAUTER_new::Int = manual_resample(ctx, "ERRCAUTER", Categorical(get_cpt(CPTs, "ERRCAUTER"), check_args = false))
...
function bayesian_network_ERRLOWOUTPUT(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    HR::Int = manual_read(ctx, "HR")

    ERRLOWOUTPUT_old::Int = manual_read(ctx, "ERRLOWOUTPUT")
    ERRLOWOUTPUT_new::Int = manual_resample(ctx, "ERRLOWOUTPUT", Categorical(get_cpt(CPTs, "ERRLOWOUTPUT"), check_args = false))
...
function bayesian_network_EXPCO2(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    VENTLUNG::Int = manual_read(ctx, "VENTLUNG")
    ARTCO2::Int = manual_read(ctx, "ARTCO2")

    EXPCO2_old::Int = manual_read(ctx, "EXPCO2")
    EXPCO2_new::Int = manual_resample(ctx, "EXPCO2", Categorical(get_cpt(CPTs, "EXPCO2", ARTCO2, VENTLUNG), check_args = false))
end

function bayesian_network_FIO2(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    VENTALV::Int = manual_read(ctx, "VENTALV")

    FIO2_old::Int = manual_read(ctx, "FIO2")
    FIO2_new::Int = manual_resample(ctx, "FIO2", Categorical(get_cpt(CPTs, "FIO2"), check_args = false))
...
function bayesian_network_HISTORY(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    LVFAILURE::Int = manual_read(ctx, "LVFAILURE")

    HISTORY_old::Int = manual_read(ctx, "HISTORY")
    HISTORY_new::Int = manual_resample(ctx, "HISTORY", Categorical(get_cpt(CPTs, "HISTORY", LVFAILURE), check_args = false))
end

function bayesian_network_HRBP(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    HR::Int = manual_read(ctx, "HR")
    ERRLOWOUTPUT::Int = manual_read(ctx, "ERRLOWOUTPUT")

    HRBP_old::Int = manual_read(ctx, "HRBP")
    HRBP_new::Int = manual_resample(ctx, "HRBP", Categorical(get_cpt(CPTs, "HRBP", ERRLOWOUTPUT, HR), check_args = false))
end

function bayesian_network_HREKG(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    HR::Int = manual_read(ctx, "HR")
    ERRCAUTER::Int = manual_read(ctx, "ERRCAUTER")

    HREKG_old::Int = manual_read(ctx, "HREKG")
    HREKG_new::Int = manual_resample(ctx, "HREKG", Categorical(get_cpt(CPTs, "HREKG", ERRCAUTER, HR), check_args = false))
end

function bayesian_network_HRSAT(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    HR::Int = manual_read(ctx, "HR")
    ERRCAUTER::Int = manual_read(ctx, "ERRCAUTER")

    HRSAT_old::Int = manual_read(ctx, "HRSAT")
    HRSAT_new::Int = manual_resample(ctx, "HRSAT", Categorical(get_cpt(CPTs, "HRSAT", ERRCAUTER, HR), check_args = false))
end

function bayesian_network_HR(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    ...
    HR_new::Int = manual_resample(ctx, "HR", Categorical(get_cpt(CPTs, "HR", CATECHOL), check_args = false))
...
function bayesian_network_HYPOVOLEMIA(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    LVFAILURE::Int = manual_read(ctx, "LVFAILURE")

    HYPOVOLEMIA_old::Int = manual_read(ctx, "HYPOVOLEMIA")
    HYPOVOLEMIA_new::Int = manual_resample(ctx, "HYPOVOLEMIA", Categorical(get_cpt(CPTs, "HYPOVOLEMIA"), check_args = false))
...
function bayesian_network_INSUFFANESTH(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    ARTCO2::Int = manual_read(ctx, "ARTCO2")
    SAO2::Int = manual_read(ctx, "SAO2")
    TPR::Int = manual_read(ctx, "TPR")

    INSUFFANESTH_old::Int = manual_read(ctx, "INSUFFANESTH")
    INSUFFANESTH_new::Int = manual_resample(ctx, "INSUFFANESTH", Categorical(get_cpt(CPTs, "INSUFFANESTH"), check_args = false))
...
function bayesian_network_INTUBATION(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    ...
    INTUBATION_new::Int = manual_resample(ctx, "INTUBATION", Categorical(get_cpt(CPTs, "INTUBATION"), check_args = false))
...
function bayesian_network_KINKEDTUBE(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    VENTTUBE::Int = manual_read(ctx, "VENTTUBE")
    INTUBATION::Int = manual_read(ctx, "INTUBATION")

    KINKEDTUBE_old::Int = manual_read(ctx, "KINKEDTUBE")
    KINKEDTUBE_new::Int = manual_resample(ctx, "KINKEDTUBE", Categorical(get_cpt(CPTs, "KINKEDTUBE"), check_args = false))
...
function bayesian_network_LVEDVOLUME(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    LVFAILURE::Int = manual_read(ctx, "LVFAILURE")
    HYPOVOLEMIA::Int = manual_read(ctx, "HYPOVOLEMIA")

    LVEDVOLUME_old::Int = manual_read(ctx, "LVEDVOLUME")
    LVEDVOLUME_new::Int = manual_resample(ctx, "LVEDVOLUME", Categorical(get_cpt(CPTs, "LVEDVOLUME", HYPOVOLEMIA, LVFAILURE), check_args = false))
...
function bayesian_network_LVFAILURE(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    HYPOVOLEMIA::Int = manual_read(ctx, "HYPOVOLEMIA")

    LVFAILURE_old::Int = manual_read(ctx, "LVFAILURE")
    LVFAILURE_new::Int = manual_resample(ctx, "LVFAILURE", Categorical(get_cpt(CPTs, "LVFAILURE"), check_args = false))
...
function bayesian_network_MINVOLSET(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    MINVOLSET_old::Int = manual_read(ctx, "MINVOLSET")
    MINVOLSET_new::Int = manual_resample(ctx, "MINVOLSET", Categorical(get_cpt(CPTs, "MINVOLSET"), check_args = false))
...
function bayesian_network_MINVOL(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    INTUBATION::Int = manual_read(ctx, "INTUBATION")
    VENTLUNG::Int = manual_read(ctx, "VENTLUNG")

    MINVOL_old::Int = manual_read(ctx, "MINVOL")
    MINVOL_new::Int = manual_resample(ctx, "MINVOL", Categorical(get_cpt(CPTs, "MINVOL", INTUBATION, VENTLUNG), check_args = false))
end

function bayesian_network_PAP(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    PULMEMBOLUS::Int = manual_read(ctx, "PULMEMBOLUS")

    PAP_old::Int = manual_read(ctx, "PAP")
    PAP_new::Int = manual_resample(ctx, "PAP", Categorical(get_cpt(CPTs, "PAP", PULMEMBOLUS), check_args = false))
end

function bayesian_network_PCWP(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    LVEDVOLUME::Int = manual_read(ctx, "LVEDVOLUME")

    PCWP_old::Int = manual_read(ctx, "PCWP")
    PCWP_new::Int = manual_resample(ctx, "PCWP", Categorical(get_cpt(CPTs, "PCWP", LVEDVOLUME), check_args = false))
end

function bayesian_network_PRESS(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    VENTTUBE::Int = manual_read(ctx, "VENTTUBE")
    INTUBATION::Int = manual_read(ctx, "INTUBATION")
    KINKEDTUBE::Int = manual_read(ctx, "KINKEDTUBE")

    PRESS_old::Int = manual_read(ctx, "PRESS")
    PRESS_new::Int = manual_resample(ctx, "PRESS", Categorical(get_cpt(CPTs, "PRESS", INTUBATION, KINKEDTUBE, VENTTUBE), check_args = false))
end

function bayesian_network_PULMEMBOLUS(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    INTUBATION::Int = manual_read(ctx, "INTUBATION")

    PULMEMBOLUS_old::Int = manual_read(ctx, "PULMEMBOLUS")
    PULMEMBOLUS_new::Int = manual_resample(ctx, "PULMEMBOLUS", Categorical(get_cpt(CPTs, "PULMEMBOLUS"), check_args = false))
...
function bayesian_network_PVSAT(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    SHUNT::Int = manual_read(ctx, "SHUNT")
    FIO2::Int = manual_read(ctx, "FIO2")
    VENTALV::Int = manual_read(ctx, "VENTALV")

    PVSAT_old::Int = manual_read(ctx, "PVSAT")
    PVSAT_new::Int = manual_resample(ctx, "PVSAT", Categorical(get_cpt(CPTs, "PVSAT", FIO2, VENTALV), check_args = false))
...
function bayesian_network_SAO2(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    SHUNT::Int = manual_read(ctx, "SHUNT")
    ARTCO2::Int = manual_read(ctx, "ARTCO2")
    ...
    SAO2_new::Int = manual_resample(ctx, "SAO2", Categorical(get_cpt(CPTs, "SAO2", PVSAT, SHUNT), check_args = false))
...
function bayesian_network_SHUNT(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    INTUBATION::Int = manual_read(ctx, "INTUBATION")
    PULMEMBOLUS::Int = manual_read(ctx, "PULMEMBOLUS")
    PVSAT::Int = manual_read(ctx, "PVSAT")

    SHUNT_old::Int = manual_read(ctx, "SHUNT")
    SHUNT_new::Int = manual_resample(ctx, "SHUNT", Categorical(get_cpt(CPTs, "SHUNT", INTUBATION, PULMEMBOLUS), check_args = false))
...
function bayesian_network_STROKEVOLUME(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    HR::Int = manual_read(ctx, "HR")
    LVFAILURE::Int = manual_read(ctx, "LVFAILURE")
    HYPOVOLEMIA::Int = manual_read(ctx, "HYPOVOLEMIA")

    STROKEVOLUME_old::Int = manual_read(ctx, "STROKEVOLUME")
    STROKEVOLUME_new::Int = manual_resample(ctx, "STROKEVOLUME", Categorical(get_cpt(CPTs, "STROKEVOLUME", HYPOVOLEMIA, LVFAILURE), check_args = false))
...
function bayesian_network_TPR(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    ARTCO2::Int = manual_read(ctx, "ARTCO2")
    SAO2::Int = manual_read(ctx, "SAO2")
    ...
    TPR_new::Int = manual_resample(ctx, "TPR", Categorical(get_cpt(CPTs, "TPR", ANAPHYLAXIS), check_args = false))
...
function bayesian_network_VENTALV(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    INTUBATION::Int = manual_read(ctx, "INTUBATION")
    FIO2::Int = manual_read(ctx, "FIO2")
    VENTLUNG::Int = manual_read(ctx, "VENTLUNG")

    VENTALV_old::Int = manual_read(ctx, "VENTALV")
    VENTALV_new::Int = manual_resample(ctx, "VENTALV", Categorical(get_cpt(CPTs, "VENTALV", INTUBATION, VENTLUNG), check_args = false))
...
function bayesian_network_VENTLUNG(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    VENTTUBE::Int = manual_read(ctx, "VENTTUBE")
    INTUBATION::Int = manual_read(ctx, "INTUBATION")
    KINKEDTUBE::Int = manual_read(ctx, "KINKEDTUBE")
    ARTCO2::Int = manual_read(ctx, "ARTCO2")
    ...
    VENTLUNG_new::Int = manual_resample(ctx, "VENTLUNG", Categorical(get_cpt(CPTs, "VENTLUNG", INTUBATION, KINKEDTUBE, VENTTUBE), check_args = false))
...
function bayesian_network_VENTMACH(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    ...
    VENTMACH_new::Int = manual_resample(ctx, "VENTMACH", Categorical(get_cpt(CPTs, "VENTMACH", MINVOLSET), check_args = false))
...
function bayesian_network_VENTTUBE(ctx::AbstractManualResampleContext, CPTs::CPTsDict)
    VENTMACH::Int = manual_read(ctx, "VENTMACH")
    DISCONNECT::Int = manual_read(ctx, "DISCONNECT")
    INTUBATION::Int = manual_read(ctx, "INTUBATION")
    KINKEDTUBE::Int = manual_read(ctx, "KINKEDTUBE")
    ...
    VENTTUBE_new::Int = manual_resample(ctx, "VENTTUBE", Categorical(get_cpt(CPTs, "VENTTUBE", DISCONNECT, VENTMACH), check_args = false))
...
function bayesian_network_manual_factor(ctx::AbstractManualResampleContext, CPTs::CPTsDict, addr::String)
    if addr == "ANAPHYLAXIS"
...
function finite_factor(ctx::AbstractManualResampleContext, addr::String)
